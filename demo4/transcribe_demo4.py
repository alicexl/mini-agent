#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Transcribe demo4.m4a with faster-whisper (large-v3, CPU int8)."""
import os, sys, time
from datetime import timedelta

# ensure ffmpeg visible
os.environ["PATH"] = r"D:\ffmpeg\bin;" + os.environ.get("PATH", "")

from faster_whisper import WhisperModel

AUDIO = r"D:\workspace\demo4.m4a"
OUT   = r"D:\workspace\demo4\demo4_transcript.txt"
